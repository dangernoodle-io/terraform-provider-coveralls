...
func TestCoverallsCreate(t *testing.T) {
	...
	got, err := client.Create(context.Background(), want)
...
func TestCoverallsGet(t *testing.T) {
	...
	got, err := client.Get(context.Background(), "github", "username/reponame")
...
func TestCoverallsUpdate(t *testing.T) {
	...
	got, err := client.Update(context.Background(), "github", "username/reponame", want)
